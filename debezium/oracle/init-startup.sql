CONNECT debezium/debezium@//localhost:1521/FREEPDB1;
...
GRANT SELECT ON products to c##replica;
...
GRANT SELECT ON customers to c##replica;
...
GRANT SELECT ON orders to c##replica;
